...
class SignupStateTests(TestCase):
    ...
    def test_happy_path_sets_pending_and_redirects_to_enroll(self):
        resp = self.client.post(reverse("accounts:signup"), {
            "username": "carol", "email": "carol@example.com", "password1": PASSWORD, "password2": PASSWORD, "accept_terms": "on",
        })
    ...
    def test_rejects_duplicate_username_case_insensitive(self):
        ...
        resp = self.client.post(reverse("accounts:signup"), {
            "username": "DAVE", "email": "dave2@example.com", "password1": PASSWORD, "password2": PASSWORD, "accept_terms": "on",
        })
    ...
    def test_rejects_mismatched_password(self):
        resp = self.client.post(reverse("accounts:signup"), {
            "username": "erin", "email": "erin@example.com", "password1": PASSWORD, "password2": "different!pw", "accept_terms": "on",
        })
        self.assertEqual(resp.status_code, 200)
    ...
    def test_rejects_weak_password(self):
        resp = self.client.post(reverse("accounts:signup"), {
            "username": "frank", "email": "frank@example.com", "password1": "password", "password2": "password", "accept_terms": "on",
        })
        self.assertEqual(resp.status_code, 200)
    ...
    def test_rejects_empty_username(self):
        resp = self.client.post(reverse("accounts:signup"), {
            "username": "", "email": "grace@example.com", "password1": PASSWORD, "password2": PASSWORD, "accept_terms": "on",
        })
        self.assertEqual(resp.status_code, 200)
